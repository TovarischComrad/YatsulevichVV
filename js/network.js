document.addEventListener('DOMContentLoaded', function() {
    ...
    const nodes = new vis.DataSet([
        ...
        { 
            ...
            group: "content",
            title: "IT",
            description: "Раздел посвящён различным информационным технологиям"
        },
        { 
            id: 3, 
            label: "ОГЭ", 
            group: "content",
            title: "ОГЭ",
            description: "Раздел посвящён подготовке к основному государственному экзамену"
        },
        { 
            id: 4, 
            label: "ЕГЭ", 
            group: "content",
            title: "ЕГЭ",
            description: "Раздел посвящён подготовке к единому государственному экзамену"
        },
        { 
            id: 5, 
            label: "НАУКА", 
            group: "content",
            title: "НАУКА",
            description: "Раздел посвящён современным лекционным материалам и научным исследованиям"
        },
        { 
            id: 6, 
            label: "КНИГИ", 
            group: "content",
            title: "КНИГИ",
            description: "Раздел посвящён решению практических задач различной литературы"
        },
        ...
        { 
            ...
            description: "Раздел посвящен основам языка программирования Python"
        },
        { 
            id: 8, 
            label: "Математика", 
            ...
            description: "Раздел посвящен подготовке к основному государственному экзамену по математике"
        },
        // { 
        //     id: 9, 
        //     label: "Информатика", 
        ...
        { 
            ...
            group: "chapter",
            title: "Физика-ОГЭ",
            description: "Раздел посвящен подготовке к основному государственному экзамену по физике"
        },
        // { 
        //     id: 11, 
        //     label: "Математика", 
        ...
        { 
            ...
            description: "Раздел посвящен подготовке к единому государственному экзамену по информатике"
        },
        // { 
        //     id: 13, 
        //     label: "Физика", 
        ...
        { 
            ...
            description: "Раздел посвящён лекциям по дисциплине Современные методы квантовых вычислений"
        },
        { 
            id: 15, 
            ...
            description: "Раздел посвящён решению практических задач книги Теория вероятностей и математическая статистика"
        },
