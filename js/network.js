document.addEventListener('DOMContentLoaded', function() {
    ...
    const nodes = new vis.DataSet([
        ...
        { 
            ...
            group: "content",
            title: "ЕГЭ",
            description: "Единый государственный экзамен. Данный экзамен является обязательным для выпускников 11 класса. В данном разделе вы сможете найти различные материалы для подготовки к ЕГЭ по математике, физике и инфоматике. Здесь есть как полноценные лекции, там и шпаргалки по формулам."
        },
        { 
            id: 5, 
            label: "НАУКА", 
